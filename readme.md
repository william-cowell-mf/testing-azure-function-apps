...
> Use this approach when you want to test that your DI container is properly configured.

The [`ConfigurationTests.cs`](/FunctionApp.Tests/ConfigurationTests.cs) looks for Azure Functions in the source project and ensures they can be instantiated by the DI container.
